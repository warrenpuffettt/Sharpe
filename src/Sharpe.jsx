        ...
        <div style={s.formWrap}><div style={s.formCard}>
          ...
          {eligible?(
            <>
              ...
              <a href="https://x.com/messages/compose?recipient_id=warrenpuffettt&text=Hey%2C+I+hit+score+"+score+"+on+Sharpe+and+want+to+set+up+alerts+for+my+followers." target="_blank" rel="noopener noreferrer" style={{display:"block",background:"#C8A96E",color:"#0A0A0F",border:"none",padding:"14px 24px",borderRadius:8,cursor:"pointer",fontSize:14,fontWeight:700,fontFamily:"inherit",width:"100%",textAlign:"center",textDecoration:"none",boxSizing:"border-box"}}>
