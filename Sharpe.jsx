...
export default function Sharpe() {
  const [view, setView] = useState("landing"); // landing | join | dashboard | leaderboard | update
  ...
  if (view === "landing") return (
    <div style={s.page}>
      ...
      <div style={s.hero}>
        ...
        <p style={s.heroSub}>
          A private leaderboard for stock traders on X. Track your monthly returns,
          win rate, and consistency. Compete on skill — not luck.
        </p>
  ...
  if (view === "join") return (
    <div style={s.page}>
      <div style={s.grain} />
      <nav style={s.nav}>
        <span style={s.logo} onClick={() => setView("landing")} style={{ ...s.logo, cursor: "pointer" }}>SHARPE</span>
      </nav>
      <div style={s.formWrap}>
        <div style={s.formCard}>
          ...
          <div style={s.fieldGroup}>
            ...
            <input style={s.input} placeholder="@yourhandle" value={joinForm.handle}
              onChange={e => setJoinForm({ ...joinForm, handle: e.target.value })} />
          </div>
          <div style={s.fieldRow}>
            <div style={s.fieldGroup}>
              <label style={s.label}>Monthly Return %</label>
              <input style={s.input} type="number" placeholder="e.g. 14.2" value={joinForm.monthlyReturn}
                onChange={e => setJoinForm({ ...joinForm, monthlyReturn: e.target.value })} />
            </div>
            <div style={s.fieldGroup}>
              <label style={s.label}>Win Rate %</label>
              <input style={s.input} type="number" placeholder="e.g. 68" value={joinForm.winRate}
                onChange={e => setJoinForm({ ...joinForm, winRate: e.target.value })} />
            </div>
          </div>
          <div style={s.fieldGroup}>
            <label style={s.label}>Trades This Month</label>
            <input style={s.input} type="number" placeholder="e.g. 22" value={joinForm.tradeCount}
              onChange={e => setJoinForm({ ...joinForm, tradeCount: e.target.value })} />
          </div>
          <div style={s.divider} />
          <div style={s.formEyebrow} style={{ ...s.formEyebrow, marginBottom: 12 }}>BEST TRADE THIS MONTH (OPTIONAL)</div>
          <div style={s.fieldRow}>
            <div style={s.fieldGroup}>
              <label style={s.label}>Ticker</label>
              <input style={s.input} placeholder="e.g. NVDA" value={joinForm.ticker}
                onChange={e => setJoinForm({ ...joinForm, ticker: e.target.value })} />
            </div>
            <div style={s.fieldGroup}>
              <label style={s.label}>% Gain</label>
              <input style={s.input} type="number" placeholder="e.g. 18.4" value={joinForm.tradePct}
                onChange={e => setJoinForm({ ...joinForm, tradePct: e.target.value })} />
            </div>
          </div>
        ...
        <div style={s.formCard}>
          ...
          <div style={s.fieldRow}>
            <div style={s.fieldGroup}>
              ...
              <input style={s.input} type="number" placeholder={currentUser?.monthlyReturn} value={updateForm.monthlyReturn}
                onChange={e => setUpdateForm({ ...updateForm, monthlyReturn: e.target.value })} />
            </div>
            <div style={s.fieldGroup}>
              <label style={s.label}>Win Rate %</label>
              <input style={s.input} type="number" placeholder={currentUser?.winRate} value={updateForm.winRate}
                onChange={e => setUpdateForm({ ...updateForm, winRate: e.target.value })} />
            </div>
          </div>
          <div style={s.fieldGroup}>
            <label style={s.label}>Total Trades This Month</label>
            <input style={s.input} type="number" placeholder={currentUser?.tradeCount} value={updateForm.tradeCount}
              onChange={e => setUpdateForm({ ...updateForm, tradeCount: e.target.value })} />
          </div>
          <div style={s.divider} />
          ...
          <div style={s.fieldRow}>
            <div style={s.fieldGroup}>
              <label style={s.label}>Ticker</label>
              <input style={s.input} placeholder="e.g. AAPL" value={updateForm.ticker}
                onChange={e => setUpdateForm({ ...updateForm, ticker: e.target.value })} />
            </div>
            <div style={s.fieldGroup}>
              <label style={s.label}>% Gain/Loss</label>
              <input style={s.input} type="number" placeholder="e.g. 9.2" value={updateForm.tradePct}
                onChange={e => setUpdateForm({ ...updateForm, tradePct: e.target.value })} />
            </div>
          </div>
